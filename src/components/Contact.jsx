...
export const Contact = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const res = await axios.post(
        "https://mert-blog-server.herokuapp.com/api",
        data
      );
      if (res.status === 200) {
  ...
  return (
    <Container fluid className="contact-container" className="bg-dark">
      <Container
        fluid
      ...
      >
        <Row className="w-100 contact">
          ...
          <Col className="d-flex align-items-center justify-content-center">
            <Image
              src="https://preview.colorlib.com/theme/bootstrap/contact-form-03/images/ximg.jpg.pagespeed.ic.XWkNClO4gV.webp"
              width="500"
              height="600"
