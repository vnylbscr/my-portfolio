                        ...
                        <div key={index} data-aos="fade-up">
                            <Col className="my-5">
                                ...
                                <Row className="mt-4 mx-2">
                                    <Image src={urlFor(post.authorImage).width(50).height(60).url()}
                                        alt={post.name} className="rounded img-fluid mr-3"
                                    />
                                ...
                                <Container className="d-flex w-100 bg-transparent justify-content-start align-items-end mt-3">
                                    <PublishedAtTitle>{dayjs(post.publishedAt).format('D MMM, YYYY')}</PublishedAtTitle>
                                </Container>
                            </Col>
                        </div>
                    )
